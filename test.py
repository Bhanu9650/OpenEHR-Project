...
# driver.close()
testname="abcd"
testemail='abcd@gmail.com'
testpass="123"
testadd="noida 62"
testage=54
testgender="male"
testphone=9999491523
...
class test(unittest.TestCase):
    def test_invalid_login(self):
        ...
        driver.maximize_window()
        driver.find_element_by_xpath('//*[@id="home"]/div/div/a').click()
    ...
    #     dtestname="abc"
    #     dtestemail='abc@gmail.com'
    #     dtestpass="123"
    #     dtestadd="noida 62"
    #     dtestyoe=12
    #     dtestspl="phycharcist"
    #     dtestphone=9999991523
    #     dtestfee=1234
    ...
    def testmodule_doctor(self):
        ...
        browser.find_element_by_xpath('//*[@id="home"]/div/div/a').click()
    ...
    def test_prescribe(self):
        ...
        docmail='jagdish@gmail.com'
        new_browser.find_element_by_xpath('//*[@id="home"]/div/div/a').click()
        ...
        #prescribe_tab4
        new_browser.find_element_by_xpath('/html/body/div[2]/div/div/div[4]/a/button').click()
        time.sleep(3)
        ...
        time.sleep(4)
        #logout
        new_browser.find_element_by_xpath('//*[@id="nav-menu"]/ul/li[3]/a').click()
        time.sleep(1)
        time.sleep(2)
        new_browser.close()
